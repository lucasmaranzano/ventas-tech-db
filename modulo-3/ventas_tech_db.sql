...
-- CREATE TABLES (primero las dimensiones, al final la tabla de hechos)
...
-- INSERT DATA (orden: primero las tablas sin dependencias)
...
-- Verificar el total de ventas (debe devolver 10)
